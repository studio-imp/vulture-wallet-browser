    ...
    <div class="itemList" style="top: 0px">
      ...
      <div class="container">
        ...
        <div style="font-size: 16px; color: var(--fg_color_2)">
          Vulture is an open-source non-custodial wallet developed by
          <a href="https://psycoders.club" target="_blank">psycoders</a><br />
          <br />
          <span style="color: var(--accent_color)">v0.3.0-alpha</span>
        </div>
      </div>
    </div>
  </div>
